    ...
    public class JobBase : IJob
    {
        ...
        public void Execute(IJobExecutionContext context)
        {
            try
            {
                ...
                finally
                {
                    ...
                    //清除30天前日志
                    if (this.jobDetail != null) new ScheduleSDK().ClearScheduleJobSaveLog(this.jobDetail.sched_name, this.jobDetail.job_name, 30);
                    if (this.jobDetail != null) new ScheduleSDK().ClearScheduleJobApiLog(this.jobDetail.sched_name, this.jobDetail.job_name, 30);
                }
            }
            catch (Exception ex)
            {
        ...
        protected void WirteScheduleLog(IJobExecutionContext context)
        {
            ...
            if (this.jobDetail != null && this.jobDetail.is_durable)
                new ScheduleSDK().WirteScheduleLog(_ScheduleLog);
        }
